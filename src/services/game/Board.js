    ...
    deal(cards) {
        ...
        switch (this.street) {
            case this.streets.preflop:
                if (cards.length !== 3) {
                    throw 'Error: Received invalid number of cards for Preflop, expected 3 got ' + cards.length;
                }
            ...
            case this.streets.flop:
                if (cards.length !== 1) {
                    throw 'Error: Received invalid number of cards for Flop, expected 1 got ' + cards.length;
                }
            ...
            case this.streets.turn:
                if (cards.length !== 1) {
                    throw 'Error: Received invalid number of cards for Turn, expected 1 got ' + cards.length;
                }
